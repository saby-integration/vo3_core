...
Процедура ОбработатьСтатусВыполнено(ДополнительныеПараметры, ТекстОповещения, КартинкаОповещения)
	...
	Если СтатусВыполнения = "error" Тогда
		...
		РезультатВыгрузки = get_prop(ДополнительныеПараметры, "Result");
...
Процедура ПоказатьОповещение(ДополнительныеПараметры)
	...
	ИменаЗаданийОтображенияОбмена.Добавить("Загрузка в " + ТРег(ЛокализацияНазваниеПродукта()));
	ИменаЗаданийОтображенияОбмена.Добавить("Выгрузка в 1С");
	ИменаЗаданийОтображенияОбмена.Добавить("Выгрузка вложений из " + ТРег(ЛокализацияНазваниеПродукта()));
	ИменаЗаданийОтображенияОбмена.Добавить("Запись вложения в " + ТРег(ЛокализацияНазваниеПродукта()));
	...
	Если ДополнительныеПараметры.Свойство("ContextId") 
		...
		НавигационнаяСсылкаОповещения = АдресСтраницыОтчетОЗагрузке(
			ПараметрыЗагрузки["params"]["ApiUrl"],
