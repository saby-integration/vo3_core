...
Функция ПроверитьЗаданиеВыполнено(ФормаЗакрывается = Ложь) Экспорт
	...
	ВыводитьПрогрессВыполнения	= get_prop(_Параметры, "ВыводитьПрогрессВыполнения", Ложь);
	ВыводитьСообщения			=  get_prop(_Параметры, "ВыводитьСообщения", Ложь);
	
	Задание = ОперацияВыполнена(ИдентификаторЗадания, Ложь, ВыводитьПрогрессВыполнения, ВыводитьСообщения);
...
Функция ОперацияВыполнена(Знач ИдентификаторЗадания, Знач ИсключениеПриОшибке = Ложь, Знач ВыводитьПрогрессВыполнения = Ложь, 
	...
	Если Задание = Неопределено Тогда
		...
		ЗаписьЖурналаРегистрации(ЛокализацияНазваниеПродукта() + ".Длительные операции.Ошибка выполнения",
