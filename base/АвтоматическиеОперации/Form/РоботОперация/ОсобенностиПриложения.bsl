...
Процедура СоздатьРеквизитыПараметровАлгоритма(ПараметрыАлгоритма) 
    ...
    ТипыРеквизитов.Вставить(СтрокаДата, Новый ОписаниеТипов(СтрокаДата, , , , , Новый КвалификаторыДаты(ЧастиДаты.Дата)));
    ТипыРеквизитов.Вставить("datetime", Новый ОписаниеТипов("Дата", , , , , Новый КвалификаторыДаты(ЧастиДаты.ДатаВремя)));
...
Функция ПолучитьИмяФайлаИНомерТекущейВерсии()
	МодульОбъекта = МодульОбъекта();
	Возврат МодульОбъекта.ПолучитьИмяФайлаИНомерТекущейВерсии();
КонецФункции
