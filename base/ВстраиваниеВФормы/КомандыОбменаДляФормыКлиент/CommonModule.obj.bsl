...
Функция ТребуетсяАутентификация(context_param, Команда, ПараметрКоманды)
	...
	Если РезультатПроверки Тогда
		...
		ПроверкаВведенныхДанныхАутентификации = Новый ОписаниеОповещения("_ПослеАутентификации", МодульКомандыОбменаДляФормыКлиент(), ВходящиеПараметры);
...
Процедура ЗапускПроверкиНаличияПлагина() Экспорт
	...
	ТранспортИнтеграции.УстановитьВариантВебИнтерфейса();
КонецПроцедуры
...
Процедура ЗапуститьОповещениеПриНаличииСессии(ОбъектОповещения, ИмяОповещения, Параметры) Экспорт
	...
	Если context_param = Неопределено Тогда
		...
		Оповещение = Новый ОписаниеОповещения(
			...
			МодульКомандыОбменаДляФормыКлиент(), 
...
Процедура ПоказатьИнформационноеОкно() Экспорт  
	Если МодульCore().ТекущемуПользователюМожноРаботатьСРасширением() Тогда 
