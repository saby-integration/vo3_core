...
Процедура ОтправитьРасчетныйЛистокВСБИС(ПараметрыВызова, context_params) Экспорт	
	...
	МодульФоновогоЗаданияКлиент().ЗапуститьINIФоновымЗаданием(
		"Blockly_РасчетныйЛисток_send",
		ПараметрыВызоваИни, 
		context_params, 
		Неопределено, 
		"Загрузка в " + ТРег(ЛокализацияНазваниеПродукта()));
КонецПроцедуры 
...
Процедура ОтправитьСокращенныйРасчетныйЛистокВСБИС(ПараметрыВызова, context_params) Экспорт
	...
	ПараметрыВызоваИни = Новый Структура("EndpointArgs", ПараметрыВызова);
	МодульФоновогоЗаданияКлиент().ЗапуститьINIФоновымЗаданием(
		"Blockly_СокращенныйРасчетныйЛисток_send", 
		ПараметрыВызоваИни, 
		context_params, 
		Неопределено, 
		"Загрузка в " + ТРег(ЛокализацияНазваниеПродукта()));
...
Процедура ОтправитьПрочийКадровыйРасчетныйЛистокВСБИС(ПараметрыОповещения) Экспорт
	...
	ПараметрыВызоваИни = Новый Структура("EndpointArgs", ПараметрыВызова);
	МодульФоновогоЗаданияКлиент().ЗапуститьINIФоновымЗаданием(
		"Blockly_ПрочийКадровыйРасчетныйЛисток_send", 
		ПараметрыВызоваИни, 
		context_params, 
		Неопределено, 
		"Загрузка в " + ТРег(ЛокализацияНазваниеПродукта()));
