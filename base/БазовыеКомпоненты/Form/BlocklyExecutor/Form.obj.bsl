...
#Область include_BlocklyExecutor_base_Rule //&НаКлиенте
#КонецОбласти
...
#Область include_core_base_АвтоматическиеОперации_ЗапускОперации //&НаКлиенте
#КонецОбласти
...
#Область include_core_base_Транспорт_LocalHelper_Session //&НаКлиенте
#КонецОбласти
...
Процедура ЗапуститьINI(Контекст) Экспорт 
	...
	МассивОперацийСНавигационнойСсылкой.Добавить("Загрузка в " + ТРег(ЛокализацияНазваниеПродукта()));
	...
	Если МассивОперацийСНавигационнойСсылкой.Найти(Контекст.НазваниеОперации) <> Неопределено Тогда
		НавигационнаяСсылкаОповещения = АдресСтраницыОтчетОЗагрузке(ПараметрыВызова["params"]["ApiUrl"],
...
#Область include_core_base_Helpers_СтруктураИзСоответствия //&НаКлиентеНаСервереБезКонтекста
#КонецОбласти
