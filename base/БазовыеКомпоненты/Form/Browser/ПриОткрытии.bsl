...
Процедура ПриОткрытии(Отказ)
	...
	#Если ВебКлиент Тогда 
		СформироватьАдресLPP(АдресСтраницы, "1c.", Domain, GostTls);
	#Иначе
	...
	Если web_interface = "BrowserSabyPlugin" Тогда
		...
		СформироватьАдресLPP(АдресСтраницы, "online-lpp1c.", Domain, GostTls);
	Иначе //web_interface = "BrowserSaby"
		...
		СформироватьАдресLPP(АдресСтраницы, "online-lppbl1c.", Domain, GostTls);
	КонецЕсли;
	#КонецЕсли
