Функция УрлСКорректнымиСимволамиПеременных(Знач ИсходныйУРЛ)
	...
	КонецЦикла;
	Результат = Saby_СтрСоединить82(НовыйУРЛМассивом, "://");
	Возврат Результат;
КонецФункции
...
Процедура СформироватьАдресСоСлужебнымиПараметрами()
	...
	ДобавитьСлужебныйПараметр(АдресСтраницыССлужебнымиПараметрами, "ext_connector", КоннекторИнтеграция);
	ДобавитьСлужебныйПараметр(АдресСтраницыССлужебнымиПараметрами, "ext_command_connector", КоннекторИнтеграция);
