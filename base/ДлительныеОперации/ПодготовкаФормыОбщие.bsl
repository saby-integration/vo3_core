...
// Подготовить параметры для запуска ini фоновым заданием
//
// Параметры:
//  ini_name - Строка - имя ini.
//  ПараметрыВызоваИни - Структура - параметры вызова.
//  context_params - Структура - контекст.
//
// Возвращаемое значение:
//  Соответствие - параметры вызова
//
&НаСервере
...
Процедура ЗапуститьФоновоеЗадание(ПараметрыЗаданияОбработки, ИмяМетода, НаименованиеФоновогоЗадания) 
	...
	ФоновоеЗадание = ФоновыеЗадания.Выполнить(ВыполняемыйМетод, 
							ПараметрыДлительныеОперации, 
							Строка(УникальныйИдентификаторЗадания), 
