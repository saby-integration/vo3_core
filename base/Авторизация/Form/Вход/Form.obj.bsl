...
Процедура ОтправитьКодАвторизации(ДополнительныеПараметры)
	...
	res = Транспорт.local_helper_exec_method(context_param, ДополнительныеПараметры.МетодОтправкиКодаПодтверждения, ПараметрыМетода,,, context_param.api_url + "/auth/service/");
КонецПроцедуры
...
Процедура ВходПроверкаКодаСМС(ДополнительныеПараметры, Код)
	...
	res = Транспорт.local_helper_exec_method(context_param, ДополнительныеПараметры.МетодПроверкиКодаИсключения, ПараметрыМетода,,, context_param.api_url + "/auth/service/");
	...
	Транспорт.ПолучитьСтатусВерсии(Истина);
КонецПроцедуры
...
Процедура Войти(Команда)
	...
	КонецЕсли;
	Попытка
		Транспорт.ВойтиТранспорт(context_param);
