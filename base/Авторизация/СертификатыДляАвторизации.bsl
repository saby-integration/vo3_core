...
&НаКлиенте
Функция СписокСертификатовДляАвторизацииНаКлиенте(МенеджерКриптографии)
...
Процедура СписокСертификатовДляАвторизацииПослеПолученияМенеджераКриптографии(МенеджерКриптографии, ДополнительныеПараметры) Экспорт
	СертификатыДляАвторизации = СписокСертификатовДляАвторизацииНаКлиенте(МенеджерКриптографии); 	
