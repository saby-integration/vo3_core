...
Процедура ДобавитьСотрудника(Команда)
	ОбработкаВыбора = SabyОписаниеОповещения("ПриЗакрытииФормыВыбораСотрудника", ЭтаФорма, "ПодборСотрудников");
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("МножественныйВыбор", Истина);
	ПараметрыФормы.Вставить("ВидДанных1С", "Справочник");
	ПараметрыФормы.Вставить("ТипДанных1С", "Сотрудники");
	ПараметрыФормы.Вставить("INI", "Blockly_Сотрудники_list"); // INI (Строка) - имя списочной инишки
