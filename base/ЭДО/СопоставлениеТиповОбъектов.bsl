...
Функция СоответствиеТиповОбъектов()
	...
	СоответствиеТипов.Добавить("АвансОтчет", "Авансовый отчёт");
	...
	СоответствиеТипов.Добавить("StaffStatements", "Кадровое заявление");
	...
	СоответствиеТипов.Добавить("РасходныйОрдер", "Расходный ордер");
	СоответствиеТипов.Добавить("ИсходящийПлатеж", "Исходящий платеж");
	СоответствиеТипов.Добавить("ФактураСкВх", "Счет-фактура полученный");
	СоответствиеТипов.Добавить("ФактураСкИсх", "Счет-фактура выданный");	
	СоответствиеТипов.Добавить("ReturnWhIn", "Возврат от покупателя");
    СоответствиеТипов.Добавить("ReturnWhOut", "Возврат поставщику");
	СоответствиеТипов.Добавить("ReturnIn", "Возврат от покупателя");
	СоответствиеТипов.Добавить("ReturnOut", "Возврат поставщику");
	СоответствиеТипов.Добавить("РеалИсх", "Реализация розницы");
	СоответствиеТипов.Добавить("АктВыпуска", "Акт выпуска");
	СоответствиеТипов.Добавить("АктСписания", "Акт списания");
	СоответствиеТипов.Добавить("ПриходныйОрдер", "Приходный ордер");
	СоответствиеТипов.Добавить("ФактураИсх", "Счет-фактура выданный");
	СоответствиеТипов.Добавить("ФактураВх", "Счет-фактура полученный");
	СоответствиеТипов.Добавить("АктИнв", "Акт инвентаризации");
    СоответствиеТипов.Добавить("АктРазбора", "Акт разбора");
	СоответствиеТипов.Добавить("ВходящийПлатеж", "Входящий платеж");
	СоответствиеТипов.Добавить("ДокументЭквайринга", "Документ эквайринга");
    СоответствиеТипов.Добавить("CorrOut", "Корректировка реализации");
	СоответствиеТипов.Добавить("CorrWhOut", "Корректировка реализации");
    СоответствиеТипов.Добавить("CorrWhIn", "Корректировка поступления");
	СоответствиеТипов.Добавить("CorrIn", "Корректировка поступления");
	СоответствиеТипов.Добавить("СчетСкИсх", "Счет на оплату");
    СоответствиеТипов.Добавить("СменаККМ", "Смена ККМ");
...
Функция Тип1СПоТипуБЛ(ТипБЛ, ПримечаниеТипа="")
	...
	Если ТипЗнч(НайденныйТип) = Тип("ЭлементСпискаЗначений") Тогда
		НайденныйТип = НайденныйТип.Представление;
	Иначе
		// Приведем к строке
		НайденныйТип = СокрЛП(НайденныйТип);
	КонецЕсли;
	...
	КонецЕсли;
	Если ПустаяСтрока(НайденныйТип) Тогда
		// Отобразим тип БЛ
		НайденныйТип = ТипБЛ;
	КонецЕсли;
	Возврат НайденныйТип;
