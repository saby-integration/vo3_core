...
Процедура СписокЗадачОбработкаВыбораСтроки()
	...
	Иначе
		...
		Форма = ФормаОсновнойОбработки("ПросмотрДокумента", ПутьКФормамОбработки(), ПараметрыФормы, ЭтаФорма);  
