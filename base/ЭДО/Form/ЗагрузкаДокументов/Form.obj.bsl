...
Процедура УстановитьВидимостьКомандВложения(СсылкаНаОбъект, ТекРегламент)
	...
	Если (ТипМетаданных = "Документы" 
		...
		И Не СсылкаСправочникИлиДокументШтатноеРасписание(СсылкаНаОбъект)
		Тогда
...
Функция ПолучитьСписокРегламентов(ВидОбъекта) 
	...
	Возврат Транспорт.local_helper_regl_get_by_types(context_params, ТипыДокументов);
КонецФункции
...
&НаСервере
Функция ТипСБИСПоТипуОбъектаАПИ(ТипОбъектаАПИ)
