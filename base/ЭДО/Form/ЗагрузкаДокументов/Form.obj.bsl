...
&НаСервере
Процедура ЗаписатьРегламентыПоУмолчанию(Знач ВидОбъекта, Знач ТекРегламент, Знач ПроизвольноеНазвание, Знач ПредставлениеОбъекта)
...
&НаСервере
Функция ПрочитатьРегламентПоУмолчанию(Знач ВидОбъекта, Знач ПредставлениеОбъекта)
