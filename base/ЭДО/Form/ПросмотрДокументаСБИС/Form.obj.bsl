...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Попытка
		...
		Если не ЗначениеЗаполнено(Подразделение) Тогда
			ДанныеДокументаПодразделение = get_prop(ДанныеДокумента,"ПодразделениеСотрудника", "Подразделение");
...
Функция ПрочитатьДокумент()
	...
	Документ = Новый Структура("Идентификатор, ПервичныйКлюч", Идентификатор, ИдСБИС);
