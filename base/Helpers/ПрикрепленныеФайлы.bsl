...
Функция ПроверитьСправочникиИРеквизиты(ИмяСправочника, ИмяРеквизитаВладельца, УчтенныеИменаСправочников) 
...
Функция ТекстЗапросаПоМассивуСправочников(Объект, ИменаФайлов, ИзмененныеПосле,
	...
	Для Каждого ЭлементМассива Из МассивИменСправочников Цикл
		...
		Если ПроверитьСправочникиИРеквизиты(ИмяСправочника, ИмяРеквизитаВладельца, УчтенныеИменаСправочников) = Ложь Тогда
			Продолжить;
		КонецЕсли;	
