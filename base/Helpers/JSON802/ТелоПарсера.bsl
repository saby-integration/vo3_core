...
// API для вызовов внутри модуля. API глобальное смотреть в другой области.

//DynamicDirective
Функция ПрочитатьJSONСтрокуВОбъект(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь, ПреобразовыватьДаты = Истина, ПриводитьКСтруктуре = Истина)
	Возврат jsonПрочитатьИнициализация(Значение, Стандарт, ПредставленияСсылок, ПреобразовыватьДаты, ПриводитьКСтруктуре);
КонецФункции 

//DynamicDirective
Функция СериализоватьПроизвольноеЗначениеВJSONСтроку(ЗначениеПреобразовать, ПараметрыКонвертации=Неопределено)
	...
	Возврат ЗначениеВJSON(ЗначениеПреобразовать, Режим);
...
// ─────────────────────────────────────────────────────────────────────────────
//  ПАРСЕР
Функция jsonПрочитатьИнициализация(Значение, Стандарт, ПредставленияСсылок, ПреобразовыватьДаты, ПриводитьКСтруктуре)
...
Функция jsonПрочитатьВнутреннийТип(Значение, Индекс)
	#Если ВебКлиент Или ТонкийКлиент Или МобильныйКлиент Или МобильноеПриложениеКлиент Тогда
...
Функция ИсключениеПустойПакетДанных() Экспорт 
	...
	Возврат "JSON: Пустой пакет данных.";
...
Функция ИсключениеНекорректныйПакетДанных(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Некорректный пакет данных в позиции [Индекс].", 
...
Функция ИсключениеНеожиданноеОкончаниеМассива(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Неожиданное окончание массива в позиции [Индекс].", 
			Новый Структура("Индекс", Индекс));
...
Функция ИсключениеНеожиданноеОкончаниеОбъетка(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Неожиданное окончание объекта в позиции [Индекс].", 
			Новый Структура("Индекс", Индекс));
...
Функция ИсключениеНекорректныйТипNull(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Некорректный тип Null в позиции [Индекс].", 
			Новый Структура("Индекс", Индекс));
...
Функция ИсключениеНекорректныйТипБулево(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Некорректный тип Булево в позиции [Индекс].",	
			Новый Структура("Индекс", Индекс));
...
Функция ИсключениеНекорректныйТипНеопределено(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Некорректный тип Неопределено в позиции [Индекс].", 
			Новый Структура("Индекс", Индекс));
...
Функция ИсключениеНекорректныйФорматСтроки(Индекс) Экспорт 
	...
	Возврат сбисШаблон("JSON: Некорректный формат строки в позиции [Индекс].", 
			Новый Структура("Индекс", Индекс));
...
Функция ИсключениеНекорректныйФорматДаты(Индекс, Значение) Экспорт 
	...
	Возврат сбисШаблон("JSON: Некорректный формат даты [Значение] в позиции [Индекс].", 
...
Функция ИсключениеНекорректныйФорматЧисла(Индекс, Значение) Экспорт 
	...
	Если ПустаяСтрока(Значение) Тогда
		...
		Возврат сбисШаблон("JSON: Неверный формат данных в позиции [Индекс].", 
				Новый Структура("Индекс", Индекс));
		
	Иначе
		
		Возврат сбисШаблон("JSON: Некорректный формат числа [Значение] в позиции [Индекс].", 
...
Функция ИсключениеНедопустимыйСимвол(Индекс, Символ) Экспорт 
	...
	Если (Символ = Неопределено) Тогда
		...
		Возврат сбисШаблон("JSON: Недопустимый символ в позиции [Индекс].",
				Новый Структура("Индекс", Индекс));
		
	Иначе
		
		Возврат сбисШаблон("JSON: Недопустимый символ в позиции [Индекс], ожидается [Символ].",
...
Функция ИсключениеНеопознанныйТип(Индекс, Тип) Экспорт 
	...
	Возврат сбисШаблон("JSON: Недопустимый тип [Тип] в позиции [Индекс].",
...
Функция ИсключениеНевозможноПреобразоватьЗначение(Индекс, Значение) Экспорт 
	...
	Возврат сбисШаблон("JSON: Невозможно преобразовать значение [Значение] в позиции [Индекс].",
			Новый Структура("Индекс,Значение", Индекс, Символ(034) + Значение + Символ(034)));
...
Функция ИсключениеНевозможноПреобразоватьЗначениеНаКлиенте(Индекс, Значение) Экспорт 
	...
	Возврат сбисШаблон("JSON: Невозможно на клиенте преобразовать значение [Значение] в позиции [Индекс].",
			Новый Структура("Индекс,Значение", Индекс, Символ(034) + Значение + Символ(034)));
...
Функция ИсключениеНекорректныйПараметр(Параметр) Экспорт 
	...
	Возврат сбисШаблон("JSON: Недопустимое значение параметра [Параметр].",
...
Функция ИсключениеНедопустимыйТипКлюча(Индекс, Значение) Экспорт 
	...
	Если (Индекс = Неопределено) Тогда
		...
		Возврат сбисШаблон("JSON: Недопустимый тип значения ключа [Тип].",
				Новый Структура("Тип", ТипЗнч(Значение)));
		
	Иначе
		
		Возврат сбисШаблон("JSON: Недопустимый тип значения ключа [Тип] в позиции [Индекс].",
...
Функция ИсключениеНевозможноВыполнитьЗапрос(Описание) Экспорт 
	...
	Возврат "JSON: Невозможно выполнить запрос. " + Сред(Описание, Позиция, Длина) + ".";
...
Функция ЗначениеВJSON(ЗначениеПреобразовать, Режим = Неопределено, ГлубинаСериализации = 0) 
	
	Если ГлубинаСериализации > 50 Тогда
		
		// Защита от зацикливания рекурсии
		ВызватьИсключение "ЗначениеВJSON: Достигнута предельная глубина вложенности (50).";
	...
	Если		ЗначениеПреобразовать = Неопределено	Тогда	//Неопределено
		...
		Если Режим = "API" Тогда
			ТекстРезультат = ЗначениеВJSON("", Режим, ГлубинаСериализации + 1);
		КонецЕсли;
	ИначеЕсли	ЗначениеПреобразовать = Null			Тогда	//Null
		ТекстРезультат = "null";
		Если Режим= "ExtSDK" Тогда
			ТекстРезультат = ЗначениеВJSON(Новый Структура, Режим, ГлубинаСериализации + 1); //При формировании сообщения, идет как dict
		КонецЕсли;	
	ИначеЕсли	_ТипЗначения = Тип("Структура")
			Или	_ТипЗначения = Тип("ФиксированнаяСтруктура") Тогда	//Структура
		ТекстРезультат = "{";
		Для Каждого КлючИЗначение Из ЗначениеПреобразовать Цикл
			ТекстРезультат = ТекстРезультат+""""+КлючИЗначение.Ключ+""":"+ ЗначениеВJSON_СоставноеЗначение(КлючИЗначение.Значение, Режим, ГлубинаСериализации + 1)+",";
		КонецЦикла;
	...
	ИначеЕсли 	_ТипЗначения = Тип("Соответствие") Тогда
		...
		Для Каждого КлючИЗначение Из ЗначениеПреобразовать Цикл
			...
			ТекстРезультат = ТекстРезультат 
				...
				+ """:" 
				+ ЗначениеВJSON_СоставноеЗначение(КлючИЗначение.Значение, Режим, ГлубинаСериализации + 1)
				+ ",";
	...
	ИначеЕсли		_ТипЗначения = Тип("Массив")			Тогда	// Массив
		...
		Для Каждого Элемент Из ЗначениеПреобразовать Цикл
			ТекстРезультат = ТекстРезультат+ЗначениеВJSON_СоставноеЗначение(Элемент, Режим, ГлубинаСериализации + 1)+",";
		КонецЦикла;
		Если Прав(ТекстРезультат, 1) = "," Тогда
			ТекстРезультат = Лев(ТекстРезультат, СтрДлина(ТекстРезультат)-1);
		КонецЕсли;		
		ТекстРезультат = ТекстРезультат + "]";
	ИначеЕсли		_ТипЗначения = Тип("СписокЗначений")	Тогда	// СписокЗначений
		
		ТекстРезультат = "[";
		Для Каждого Элемент Из ЗначениеПреобразовать Цикл
			
			ТекстРезультат = ТекстРезультат + "{""Представление"": """	+ Элемент.Представление												+ """,";
			ТекстРезультат = ТекстРезультат + """Отмечен"":"			+ ЗначениеВJSON(Элемент.Пометка,	Режим, ГлубинаСериализации + 1)	+ ",";
			ТекстРезультат = ТекстРезультат + """Значение"":"			+ ЗначениеВJSON_СоставноеЗначение(Элемент.Значение,	Режим, ГлубинаСериализации + 1)	+ "},";
	...
	Иначе
		...
		ИначеЕсли		Режим = "Лог"
				И	Не	_ТипЗначения = Тип("Строка")		Тогда	// Неизвестный тип				
		                           			
			ЗначениеДляПреобразовать = Новый ФиксированнаяСтруктура("Объект_Тип, Объект_Значение", ТипЗнч(ЗначениеПреобразовать), ЗначениеПреобразовать);
			Возврат ЗначениеВJSON(ЗначениеДляПреобразовать,, ГлубинаСериализации)
		...
		Если ГлубинаСериализации Тогда // Для 0 уровня не оборачиваем кавычками строку
...
Функция ЗначениеВJSON_СоставноеЗначение(ЗначениеВходящее, Режим = Неопределено, ГлубинаСериализации = 0) 
	
	ЗначениеПреобразовать = ЗначениеВходящее;
	
	Если Режим = "Лог" Тогда
	
		Если ОбъектSABY_ЭтоТип(ЗначениеПреобразовать, "ОбъектSaby") Тогда
			
			// Метод dump для лога.
			ТипОбъекта = ОбъектSABY_Получить(ЗначениеПреобразовать, "Тип");
			Попытка
				
				ЗначениеПреобразовать = Вычислить(ТипОбъекта + "_Выгрузить(ЗначениеПреобразовать, ""ЗаписьДляЛога"")");
				
			Исключение
				
				Если ОбъектSABY_ЭтоТип(ЗначениеПреобразовать, "ПрикладнойОбъектSaby") Тогда
					
					// Для прикладного объекта использовать его метод, т.к. из-за контекста вызова методы объектов могут быть недоступны.
					ЗначениеПреобразовать = Вычислить("ПрикладнойОбъектSABY_Выгрузить(ЗначениеПреобразовать, ""ЗаписьДляЛога"")");
					
				Иначе
					
					ЗначениеПреобразовать = ОбъектSABY_Выгрузить(ЗначениеПреобразовать, "ЗаписьДляЛога");
	...
	Возврат ЗначениеВJSON(ЗначениеПреобразовать, Режим, ГлубинаСериализации);
