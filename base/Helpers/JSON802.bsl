	...
	Если Режим = "Лог" Тогда
		...
		Если ОбъектSABY_ЭтоТип(ЗначениеПреобразовать, "ОбъектSaby") Тогда
			...
			Попытка
				...
				ЗначениеПреобразовать = Вычислить(ТипОбъекта + "_Выгрузить(ЗначениеВыгрузки, ""объект"")");
				
			Исключение
				
				ЗначениеПреобразовать = "Для типа """ + ТипОбъекта + """ отсутствует описание сериализации в JSON";
