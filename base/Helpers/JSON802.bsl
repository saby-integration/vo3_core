...
Функция local_helper_json_decode(json, ВСоответствие = Истина) Экспорт
	Возврат сбисПрочитатьJSON(json, , , , Не ВСоответствие);
КонецФункции
...
Функция ЗначениеВJSON(ЗначениеПреобразовать, Режим, ПервыйУровень=Истина) 
	...
	ИначеЕсли	_ТипЗначения = Тип("СписокЗначений")	Тогда	// СписокЗначений
		...
		Для Каждого Элемент Из ЗначениеПреобразовать Цикл
			...
			ТекстРезультат = ТекстРезультат + """Отмечен"":"			+ ЗначениеВJSON(Элемент.Пометка,	Режим, Ложь)	+ ",";
			ТекстРезультат = ТекстРезультат + """Значение"":"			+ ЗначениеВJSON(Элемент.Значение,	Режим, Ложь)	+ "},";
