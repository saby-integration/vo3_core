...
Функция НайтиРегламентноеЗаданиеИПолучитьЕгоРасписаниеСервер()
	ЭтаФорма.ИдентификаторРегламентногоЗадания = "";
	Возврат ПолучитьРасписание(ЭтаФорма.ИдентификаторРегламентногоЗадания);
КонецФункции
...
Функция ПолучитьРегламентноеЗадание()
	Задание = РегламентныеЗаданияСервер.ПолучитьРегламентноеЗадание(ЭтаФорма.ИдентификаторРегламентногоЗадания);
    Возврат Задание;
КонецФункции
...
Процедура ИспольваниеРегламентногоЗаданияПриИзменении(Элемент)
	...
	ИзменитьРегламентноеЗадание(ЭтаФорма.ИдентификаторРегламентногоЗадания, ПараметрыЗадания);
КонецПроцедуры
