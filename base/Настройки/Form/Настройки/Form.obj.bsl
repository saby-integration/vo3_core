...
Процедура ЗагрузитьСопоставленияНажатие(Элемент)
	...
	ПараметрыВыполнения.Добавить(Новый Структура("ПараметрыВыполнения"));

	Saby_ФоновыеЗаданияКлиент.ОткрытьФормуДлительнойОперации(
		"Saby_ФоновыеЗаданияСервер.ЗагрузитьСопоставленияНаСервере", // Имя метода
		ПараметрыВыполнения,
...
#Область include_core_base_Настройки_Form_Настройки_ЗагрузитьСопоставленияНаСервере
#КонецОбласти
