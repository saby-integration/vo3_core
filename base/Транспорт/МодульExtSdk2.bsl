...
Функция CallMethodWithoutAuthExtSdk2(QueryId, Sbi3Module_ID, MethodName, Call_param, Хост)
	Call_param_encode = encode_xdto_json(Call_param);
	Возврат Компонента.CallMethodWithoutAuth(QueryId, Sbi3Module_ID, MethodName, Call_param_encode, Хост);
КонецФункции
