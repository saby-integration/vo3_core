...
#Область include_core_base_Транспорт_LocalHelper //&НаКлиенте
#КонецОбласти

#Область include_core_base_Классы_ОбъектSABY_ПриватныеМетоды //&НаКлиенте
#КонецОбласти

#Область include_core_base_Классы_ОбъектSABY_АПИ //&НаКлиенте
#КонецОбласти

#Область include_core_base_Helpers_JSON802 //&НаКлиенте
#КонецОбласти
...
#Область include_core_base_Транспорт_API //&НаКлиенте
#КонецОбласти

#Область include_core_base_ЗапускМодуля_ПриСозданииНовойИнтеграции //&НаКлиенте
#КонецОбласти

#Область include_core_base_ЗапускМодуля_ПроверкаВерсии_ВМодулеОбъекта //&НаКлиенте
#КонецОбласти
